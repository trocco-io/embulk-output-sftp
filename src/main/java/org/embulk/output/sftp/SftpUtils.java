...
public class SftpUtils
{
    ...
    FileObject newSftpFile(final URI sftpUri) throws FileSystemException
    {
        ...
        logger.info("Current file path: {}", file.getPublicURIString());

        FileObject parent = file.getParent();
        if (parent == null) {
            logger.warn("Unable to retrieve the parent directory for {}. Skipping further processing.", sftpUri.toString());
            return null;
        }
